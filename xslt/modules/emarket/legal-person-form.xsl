	...
	<xsl:template match="field" mode="legal_form">
		...
		<div class="required field">
			<label title="{@tip}">
				...
				<span>
					<xsl:attribute name="class">required_star</xsl:attribute>
...
<!--	<div xmlns="http://www.w3.org/1999/xhtml" class="required field">
		<label>
			<span>Почтовый индекс:</span>
			<span class="required_star" title="Обязательное поле">
				<span class="required_star_text">*</span>
			</span>
		</label>
		<div class="field_div input">
			<input type="text" name="data[new][index]" value="">
		</div>
	</div>-->
